...
public class SampleResource {
    ...
    public String hello() throws Exception {
            ...
            String parseLine; 
			String strHello = "<center><h1>Hello and welcome to Suchit's CI/CD Pipeline Demo! ----- Version 4.0</h1><br>";
            String strDia = "<br><h2>High Level Architecture Diagram</h2><br><img src=/spdevops.jpg><br>";
            String strDoc = "<h2><a href=http://blog.suchit23.in/devops-cicd-using-jenkins-maven-docker-sonar-selenium-kubernetes/> Step by Step Guide to implement this project</h2></center><br>";
